...
#include "BP_death_area__pf2132744816.h"
...
ABP_death_area_C__pf2132744816::ABP_death_area_C__pf2132744816(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (ABP_death_area_C__pf2132744816::StaticClass() == GetClass()))
	{
		ABP_death_area_C__pf2132744816::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
...
void ABP_death_area_C__pf2132744816::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ABP_death_area_C__pf2132744816::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void ABP_death_area_C__pf2132744816::bpf__ExecuteUbergraph_BP_death_area__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	if(::IsValid(b0l__K2Node_DynamicCast_AsBP_Ball__pf))
	{
		b0l__K2Node_DynamicCast_AsBP_Ball__pf->K2_DestroyActor();
	}
	return; // KCST_GotoReturn
}
void ABP_death_area_C__pf2132744816::bpf__ReceiveActorBeginOverlap__pf(AActor* bpp__OtherActor__pf)
{
	b0l__K2Node_Event_OtherActor__pf = bpp__OtherActor__pf;
	bpf__ExecuteUbergraph_BP_death_area__pf_0(1);
}
PRAGMA_DISABLE_OPTIMIZATION
void ABP_death_area_C__pf2132744816::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABP_death_area_C__pf2132744816::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{82, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.BoxComponent 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABP_death_area_C__pf2132744816
{
	FRegisterHelper__ABP_death_area_C__pf2132744816()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/blueprints/BP_death_area"), &ABP_death_area_C__pf2132744816::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABP_death_area_C__pf2132744816 Instance;
};
FRegisterHelper__ABP_death_area_C__pf2132744816 FRegisterHelper__ABP_death_area_C__pf2132744816::Instance;
