...
ABP_ball_C__pf2132744816::ABP_ball_C__pf2132744816(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	if(HasAnyFlags(RF_ClassDefaultObject) && (ABP_ball_C__pf2132744816::StaticClass() == GetClass()))
	{
		ABP_ball_C__pf2132744816::__CustomDynamicClassInitialization(CastChecked<UDynamicClass>(GetClass()));
	}
	...
	auto& __Local__0 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__ball__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__0 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABP_ball_C__pf2132744816::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	bpv__ball__pf->SetCollisionProfileName(FName(TEXT("PhysicsActor")));
	bpv__ball__pf->BodyInstance.bSimulatePhysics = true;
	bpv__ball__pf->BodyInstance.bEnableGravity = false;
	...
	(((UBoolProperty*)__Local__1)->SetPropertyValue_InContainer((bpv__ball__pf), true, 0));
	bpv__Audio__pf->CreationMethod = EComponentCreationMethod::Native;
	bpv__Audio__pf->AttachToComponent(bpv__ball__pf, FAttachmentTransformRules::KeepRelativeTransform );
	bpv__Audio__pf->Sound = CastChecked<USoundBase>(CastChecked<UDynamicClass>(ABP_ball_C__pf2132744816::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	(((UBoolProperty*)__Local__1)->SetPropertyValue_InContainer((bpv__Audio__pf), false, 0));
	bpv__speed__pf = -2000.000000f;
	bpv__stickness__pf = 20000.000000f;
	PrimaryActorTick.bCanEverTick = true;
}
PRAGMA_ENABLE_OPTIMIZATION
void ABP_ball_C__pf2132744816::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ABP_ball_C__pf2132744816::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void ABP_ball_C__pf2132744816::bpf__ExecuteUbergraph_BP_ball__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	do
	{
		...
		case 3:
			{
				...
				bpfv__CallFunc_FClamp_ReturnValue_1__pf = UKismetMathLibrary::FClamp(bpfv__CallFunc_Divide_FloatFloat_ReturnValue__pf, 0.000000, 1.000000);
				if(::IsValid(bpv__Audio__pf))
				{
					bpv__Audio__pf->UAudioComponent::SetVolumeMultiplier(bpfv__CallFunc_FClamp_ReturnValue_1__pf);
				}
			}
		case 4:
			{
				...
				bpfv__CallFunc_VSize_ReturnValue__pf = UKismetMathLibrary::VSize(bpfv__CallFunc_GetVelocity_ReturnValue__pf);
				bpfv__CallFunc_Divide_FloatFloat_ReturnValue__pf = FCustomThunkTemplates::Divide_FloatFloat(bpfv__CallFunc_VSize_ReturnValue__pf, 2000.000000);
				bpfv__CallFunc_FClamp_ReturnValue__pf = UKismetMathLibrary::FClamp(bpfv__CallFunc_Divide_FloatFloat_ReturnValue__pf, 0.900000, 1.100000);
				if(::IsValid(bpv__Audio__pf))
				{
					bpv__Audio__pf->UAudioComponent::SetPitchMultiplier(bpfv__CallFunc_FClamp_ReturnValue__pf);
				}
		...
		case 5:
			{
				bpfv__CallFunc_Multiply_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Multiply_FloatFloat(b0l__K2Node_Event_DeltaSeconds__pf, bpv__speed__pf);
				bpfv__CallFunc_MakeVector_ReturnValue__pf = UKismetMathLibrary::MakeVector(bpfv__CallFunc_Multiply_FloatFloat_ReturnValue__pf, 0.000000, 0.000000);
				if(::IsValid(bpv__ball__pf))
				{
					bpv__ball__pf->AddImpulse(bpfv__CallFunc_MakeVector_ReturnValue__pf, FName(TEXT("None")), true);
				}
			}
		case 6:
			{
				bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf = AActor::K2_GetActorLocation();
				bpfv__CallFunc_Subtract_VectorVector_ReturnValue__pf = UKismetMathLibrary::Subtract_VectorVector(bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf, FVector(0.000000,0.000000,500.000000));
				bpfv__CallFunc_LineTraceSingle_ReturnValue__pf = UKismetSystemLibrary::LineTraceSingle(this, bpfv__CallFunc_K2_GetActorLocation_ReturnValue__pf, bpfv__CallFunc_Subtract_VectorVector_ReturnValue__pf, ETraceTypeQuery::TraceTypeQuery1, false, b0l_____object_Variable__pf, EDrawDebugTrace::None, /*out*/ b0l__CallFunc_LineTraceSingle_OutHit__pf, true, FLinearColor(1.000000,0.000000,0.000000,1.000000), FLinearColor(0.000000,1.000000,0.000000,1.000000), 5.000000);
			}
		case 7:
			{
				...
				bpfv__CallFunc_Multiply_VectorInt_ReturnValue__pf = UKismetMathLibrary::Multiply_VectorInt(b0l__CallFunc_BreakHitResult_ImpactNormal__pf, -1);
				bpfv__CallFunc_Multiply_VectorFloat_ReturnValue__pf = UKismetMathLibrary::Multiply_VectorFloat(bpfv__CallFunc_Multiply_VectorInt_ReturnValue__pf, bpv__stickness__pf);
				bpfv__CallFunc_Multiply_VectorFloat_ReturnValue_1__pf = UKismetMathLibrary::Multiply_VectorFloat(bpfv__CallFunc_Multiply_VectorFloat_ReturnValue__pf, b0l__K2Node_Event_DeltaSeconds__pf);
				if(::IsValid(bpv__ball__pf))
				{
					bpv__ball__pf->AddImpulse(bpfv__CallFunc_Multiply_VectorFloat_ReturnValue_1__pf, FName(TEXT("None")), true);
				}
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
...
void ABP_ball_C__pf2132744816::bpf__ReceiveTick__pf(float bpp__DeltaSeconds__pf)
{
	b0l__K2Node_Event_DeltaSeconds__pf = bpp__DeltaSeconds__pf;
	bpf__ExecuteUbergraph_BP_ball__pf_0(1);
}
PRAGMA_DISABLE_OPTIMIZATION
void ABP_ball_C__pf2132744816::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABP_ball_C__pf2132744816::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{34, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.AudioComponent 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABP_ball_C__pf2132744816
{
	FRegisterHelper__ABP_ball_C__pf2132744816()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/Game/blueprints/BP_ball"), &ABP_ball_C__pf2132744816::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABP_ball_C__pf2132744816 Instance;
};
FRegisterHelper__ABP_ball_C__pf2132744816 FRegisterHelper__ABP_ball_C__pf2132744816::Instance;
